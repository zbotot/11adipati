...
line = LINE("EvWfIBeVey3hcCLidlq4.0j4LWmQuIB5Kw0R7amj/5a.Af8cgtlXYBsFQFDLycwkopKEC6CgqwGQMVptoRUo9+w=")  #ISI DISINI DENGAN TOKEN CHROME,,,
                        ...
                        for mention in mentionees:
                            if lineMID in mention["M"]:
                              if Settings["detectMention"] == True:
                                 sendMention(receiver, sender, "", "❂➣ᴀᴜᴛᴏʀᴇsᴘᴏɴ ᴀᴅɪᴘᴀᴛɪ_ʙᴏᴛ \n❂➣ ᴊᴀɴɢᴀɴ ᴛᴀɢ ᴀᴋᴜ \n❂➣ ᴛᴀᴘɪ ᴛɪᴋᴜɴɢ ᴀᴋᴜ 😛😛 ")
